...
public class QPosts extends EntityPathBase<Posts> {
    ...
    private static final long serialVersionUID = -861304896L;

    public static final QPosts posts = new QPosts("posts");

    public final com.jungwoo.book.springboot.domain.QBaseTimeEntity _super = new com.jungwoo.book.springboot.domain.QBaseTimeEntity(this);
